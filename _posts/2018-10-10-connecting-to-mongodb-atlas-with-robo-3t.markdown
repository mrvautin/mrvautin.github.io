...
<figure class="kg-card kg-image-card"><img src="{{site.base_url}}/content/images/2018/10/image.png" class="kg-image"></figure>

2. Fill in Database as "admin", Username/Password as per the user setup in MongoDB Atlas.

<figure class="kg-card kg-image-card"><img src="{{site.base_url}}/content/images/2018/10/image-1.png" class="kg-image"></figure>

3. Skip SSH tab

4. Click "Use SSL protocol" then select "Self-signed Certificate" from the dropdown.

<figure class="kg-card kg-image-card"><img src="{{site.base_url}}/content/images/2018/10/image-3.png" class="kg-image"></figure>
